...
int main(void)
{
  ...
  while (1) {
    ...
    if (orientacja2!=orientacja1) {                 //aktualizacja tylko gdy zmienila sie orientacja
      switch (orientacja2){
        case 0 :
        case 1 : {TFTN_Rotate(0); aktualizacja=0;} break;
        case 5 : {TFTN_Rotate(2); aktualizacja=0;} break;
        case 2 : {TFTN_Rotate(1); aktualizacja=0;} break;
        case 6 : {TFTN_Rotate(3); aktualizacja=0;} break;
      }
    }
...
//konfigurowanie sygnalow taktujacych
{
  ...
  if(HSEStartUpStatus == SUCCESS)
  {
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOE, ENABLE);//wlacz taktowanie portu GPIO E - MEMS1
  } else {
  } 
}
