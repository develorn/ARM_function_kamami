...
void EXTI0_IRQHandler(void)
{
  ...
  stanGPIOB=stanGPIOB&0xC0FF;                   //Wyzeruj bity odpowiedzialne za LEDy, z wyjatkiem LED 8 i 7 
  stanGPIOB=stanGPIOB | (licznik << 8);
  GPIO_Write(GPIOB, stanGPIOB);                 //zapisz nowy stan portu
