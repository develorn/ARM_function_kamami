...
int main(void)
{
  ...
  unsigned char *menu[12] = {"Dioda 1\0","Dioda 2\0","Dioda 3\0","Dioda 4\0","Dioda 5\0","Dioda 6\0","Dioda 7\0","Dioda 8\0","Bat. 0%\0","Bat. 50%\0","Bat. 100%\0","Klepsydra\0"};
  const unsigned char znakiDodatkowe[32] = {0x04,0x1F,0x11,0x11,0x11,0x11,0x1F,0,  //bateria pusta
                                            0x04,0x1F,0x11,0x11,0x1F,0x1F,0x1F,0,  //bateria 50%
                                            0x04,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0,  //bateria 100%
  ...
  while (1) {
    if (!GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_1) && (pozycja<12)) {
      pozycja++;
    ...
    if (!GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_5)){
      switch (pozycja){
        ...
        case 8: Opcja8(); break;
        case 9: Opcja9(); break;
        case 10: Opcja10(); break;
        case 11: Opcja11(); break;
        case 12: Opcja12(); break;
